sap.ui.define([
    ...
    return {
        getData: function (oContext, aSelectedContexts) {
            ...
            // Confirmation Dialog
            MessageBox.confirm(
                "Do you want to getData from Sales Order: " + oData.SalesOrder + "?",
                {
                    ...
                    onClose: function (sAction) {
                        if (sAction === MessageBox.Action.YES) {
                            ...
                            $.ajax({
                                url: '/odata/v4/sales-order/getData',
                                method: 'POST',
                                contentType: 'application/json',
                                data: JSON.stringify(data),
                                success: function (response) {
                                    MessageToast.show("Sales Order data is Approved");
                                    // oSelectedContext.refresh();
                                    // oModel.refresh();
                                },
                                error: function () {
                                    MessageToast.show("getData failed");
                                }
                            });
                        }
                    }
